...
import { ec2, currentStack } from './lib/api.js'
...
async function podStatus() {
  // Sidebar status card: reflects the EC2 view of the SELECTED stack, refreshed on each
  // render. Naming the stack matters now that two pods can be running at once — otherwise
  // "Pod — running" is ambiguous about which one you are driving.
